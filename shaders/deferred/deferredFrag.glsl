...
void main()
{  
    m_gBufferNormal = vec4(max(normalize(TBN*(texture(tex_Normal, TexCoords).rgb*2.0-1.0)),0)*inNormalMult + Normal*(1-inNormalMult),1);
    ...
    m_gBufferEmissive = vec4(emissive, 0.0);
